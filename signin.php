 ...
 */
const CLIENT_ID = '65285371786-iqs1ironui565sba831i5fj9ddkocl0e';

/**
 * Replace this with the client secret you got from the Google APIs console.
 */
const CLIENT_SECRET = 'Jhj29fe47M5E7MefUijSMrcD';

/**
 * Optionally replace this with your application's name.
 */
const APPLICATION_NAME = "Login to Readers Junction";
